...
import { saveSectorizacionCoordinadorAction } from "../actions";

export default async function SectorizacionActorCoordinadorPage(props: {
  ...
  return (
    <AppShell user={user} title="Sectorización" fullWidth>
      <div className="flex flex-col gap-4">
        ...
        <div className="rounded-2xl bg-white ring-1 ring-black/5 p-5">
          ...
          <form
            action={saveSectorizacionCoordinadorAction}
