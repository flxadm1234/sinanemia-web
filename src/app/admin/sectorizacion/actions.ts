...
export async function saveSectorizacionAction(formData: FormData) {
  ...
  if (user.tipo === "ADMINISTRADOR") {
    if ((persona.ubigeo ?? null) !== (user.ubigeo ?? null)) return;
  }
  ...
  revalidatePath(`/admin/sectorizacion/${persona.idpersona}`);
