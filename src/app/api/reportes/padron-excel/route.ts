  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      cols: [
        ...
        { label: "F. atención (últ.)", cell: (r) => tdDate(r.tam_fecha_atencion) },
        { label: "Hemoglobina (últ.)", cell: (r) => td(r.tam_hemoglobina ?? "") },
        { label: "Peso (últ.)", cell: (r) => td(r.tam_peso ?? "") },
        { label: "Talla (últ.)", cell: (r) => td(r.tam_talla ?? "") },
        { label: "CIE10 (últ.)", cell: (r) => td(r.tam_cie_10 ?? "") },
        { label: "Resultado (últ.)", cell: (r) => td(r.tam_resultado ?? "") },
        { label: "Hemoglobina1", cell: (r) => td(r.hemoglobina1 ?? "") },
        { label: "F. atención1", cell: (r) => tdDate(r.fecha_atencion1) },
        { label: "Hemoglobina2", cell: (r) => td(r.hemoglobina2 ?? "") },
        { label: "F. atención2", cell: (r) => tdDate(r.fecha_atencion2) },
        { label: "Hemoglobina3", cell: (r) => td(r.hemoglobina3 ?? "") },
        { label: "F. atención3", cell: (r) => tdDate(r.fecha_atencion3) },
